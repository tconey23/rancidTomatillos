describe('home page', () => {
    ...
    it('should display a page title and collection of movies on page load', () => {
      ...
      .get('a').eq(5)
      .contains('h2', 'Cats & Dogs 3: Paws Unite')
      .get('a').eq(5)
  ...
  it('should display a specific movie\'s details when clicked', () => {
    ...
    cy.get('.modal-content').contains('h3', 'Money Plane')
    cy.get('.modal-content').contains('h4', 'Its a movie about a plane with money on it')
